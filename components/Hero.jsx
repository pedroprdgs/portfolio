    ...
    return(
        <section className="flex items-center justify-center h-screen text-center">
            <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2 }}>
                <motion.img className="h-82 w-82 justify-self-center mb-8 rounded-full border-10 border-b-teal-900 border-neutral-700" initial={{ y: -200 }} animate={{ y: 0 }} transition={{ duration: 1.5 }} src="../src/assets/profile.jpg" alt="A photo of me 🎭" />
